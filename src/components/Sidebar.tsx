  ...
  return (
    <aside className={styles.sidebar}>
      ...
      <div className={styles.profile}>
        <Avatar src="https://plus.unsplash.com/premium_photo-1664536392896-cd1743f9c02c?q=60&w=200&h=200auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
